  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        activeElements: ["server-os", "server-nat", "server-nic"],
        packetLocation: "server-nat",
        packetFrom: "server-vpn-process",
        packetTo: "server-nat",
        packetPath: ["server-vpn-process", "server-nat", "server-nic-in"],
        packetStatus: "raw",
        packetLabel: "Decrypted PAYLOAD",
      },
      {
        id: 9,
        ...
        packetPath: ["server-nic-in", "target-internet"],
        packetStatus: "raw",
        packetLabel: "HTTP(S)",
      },
      {
      ...
      },
      {
        ...
        activeElements: ["data-tunnel", "server-nic"],
        packetLocation: "data-tunnel",
        packetFrom: "server-vpn-process",
        packetTo: "data-tunnel",
        packetPath: ["server-vpn-process", "server-nic-in", "data-tunnel"],
        packetStatus: "encrypted",
      ...
      },
      {
        ...
        activeElements: ["client-vpn-process", "client-nic"],
        packetLocation: "vpn-client-read",
        packetFrom: "data-tunnel",
        packetTo: "vpn-client-read",
        packetPath: ["data-tunnel", "nic-out", "vpn-client-read"],
        packetStatus: "encrypted",
